const AboutMeText = () => {
  return (
    <div className="mx-4 xl:mx-[160px] mt-[124px] xl:mt-[180px] xl:flex xl:items-start xl:justify-center xl:gap-4">
      <p className="text-3xl font-medium xl:text-[56px] xl:leading-[67.2px] xl:w-1/2">
        About Me
      </p>
      <div className="xl:w-1/2">
        ...
        <p className="mt-[30px] text-[18px] leading-[28px] xl:text-[24px] xl:leading-[39px] font-medium tracking-tight text-[rgba(0,31,31,0.5)]">
          ...
          shaping businesses that have impacted lives across industries. My
          journey is one of constant evolution, where each chapter has brought
          new challenges, learning, and success. I invite you to explore the
          milestones that have defined my career and the values that drive my
